...
namespace streamer::checkpoints
{
    ...
    Item::SharedCheckpoint CreateDynamicCheckpoint(std::optional<AMX*> amx, const Eigen::Vector3f& position, float size, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority);
    Item::SharedCheckpoint CreateDynamicCheckpointEx(std::optional<AMX*> amx, const Eigen::Vector3f& position, float size, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority);
