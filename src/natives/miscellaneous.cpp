...
cell AMX_NATIVE_CALL Natives::Streamer_GetDistanceToItem(AMX *amx, cell *params)
{
    ...
    auto distance = streamer::miscellaneous::GetDistanceToItem({ amx_ctof(params[1]), amx_ctof(params[2]), amx_ctof(params[3]) }, static_cast<StreamerItemType>(params[4]), static_cast<int>(params[5]), static_cast<int>(params[7]));
    if (distance.has_value())
    {
        Utility::storeFloatInNative(amx, params[6], distance.value());
        return 1;
    }
...
cell AMX_NATIVE_CALL Natives::Streamer_ToggleItem(AMX *amx, cell *params)
{
    ...
    if (streamer::miscellaneous::ToggleItem(static_cast<int>(params[1]), static_cast<StreamerItemType>(params[2]), static_cast<int>(params[3]), static_cast<int>(params[4]) != 0)) return 1;
	return 0;
}
...
cell AMX_NATIVE_CALL Natives::Streamer_IsToggleItem(AMX *amx, cell *params)
{
    ...
    if (streamer::miscellaneous::IsToggleItem(static_cast<int>(params[1]), static_cast<StreamerItemType>(params[2]), static_cast<int>(params[3]))) return 1;
    return 0;
}
