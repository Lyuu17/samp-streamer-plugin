...
StringView OmpStreamerComponent::componentName() const
{
    return "open.mp streamer";
}

SemanticVersion OmpStreamerComponent::componentVersion() const
{
...
void OmpStreamerComponent::onInit(IComponentList* components)
{
...
void OmpStreamerComponent::onReady()
{
    // Fire events here at earliest
}

void OmpStreamerComponent::onTick(Microseconds elapsed, TimePoint now)
{
    core->getStreamer()->startAutomaticUpdate();
}

void OmpStreamerComponent::onAmxLoad(IPawnScript& script)
{
...
void OmpStreamerComponent::onAmxUnload(IPawnScript& script)
{
...
void OmpStreamerComponent::onFree(IComponent* component)
{
...
void OmpStreamerComponent::reset()
{
}

void OmpStreamerComponent::free()
{
    if (pawnComponent != nullptr)
    {
...
bool OmpStreamerComponent::onSend(IPlayer* peer, NetworkBitStream& bs)
{
...
// actors
std::shared_ptr<streamer::IActor> OmpStreamerComponent::getDynamicActor(int actorId)
{
    return streamer::actors::GetDynamicActor(actorId);
}

std::shared_ptr<streamer::IActor> OmpStreamerComponent::createDynamicActor(int modelId, const Vector3& position, float rotation, bool invulnerable, float health, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)
{
...
std::shared_ptr<streamer::IActor> OmpStreamerComponent::createDynamicActorEx(int modelId, const Vector3& position, float rotation, bool invulnerable, float health, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicActor(int actorId)
{
    return streamer::actors::DestroyDynamicActor(actorId);
}

bool OmpStreamerComponent::isDynamicActorStreamedIn(int actorId, int playerId)
{
    return streamer::actors::IsDynamicActorStreamedIn(actorId, playerId);
}

std::shared_ptr<streamer::IActor> OmpStreamerComponent::getPlayerTargetDynamicActor(int playerId)
{
    return streamer::actors::GetPlayerTargetDynamicActor(playerId);
}

std::shared_ptr<streamer::IActor> OmpStreamerComponent::getPlayerCameraTargetDynActor(int playerId)
{
    return streamer::actors::GetPlayerCameraTargetDynActor(playerId);
}

// areas
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicCircle(const Vector2& position, float size, int worldId, int interiorId, int playerId, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicCylinder(const Vector2& position, const Vector2& height, float size, int worldId, int interiorId, int playerId, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicSphere(const Vector3& position, float size, int worldId, int interiorId, int playerId, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicRectangle(const Vector2& minposition, const Vector2& maxposition, int worldId, int interiorId, int playerId, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicCuboid(const Vector3& minposition, const Vector3& maxposition, int worldId, int interiorId, int playerId, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicPolygon(const std::vector<Vector2>& points, const Vector2& height, int worldId, int interiorId, int playerId, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicCircleEx(const Vector2& position, float size, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicCylinderEx(const Vector2& position, const Vector2& height, float size, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicSphereEx(const Vector3& position, float size, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicRectangleEx(const Vector2& minposition, const Vector2& maxposition, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicCuboidEx(const Vector3& minposition, const Vector3& maxposition, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, int priority)
{
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::createDynamicPolygonEx(const std::vector<Vector2>& points, const Vector2& height, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, int priority)
{
    std::vector<Eigen::Vector2f> p;
    for (const auto& point : points)
        p.push_back({ point.x, point.y });
...
std::shared_ptr<streamer::IArea> OmpStreamerComponent::getDynamicArea(int areaId)
{
    return streamer::areas::GetDynamicArea(areaId);
}

bool OmpStreamerComponent::destroyDynamicArea(int areaId)
{
    return streamer::areas::DestroyDynamicArea(areaId);
}

// checkpoints
std::shared_ptr<streamer::ICheckpoint> OmpStreamerComponent::getDynamicCheckpoint(int checkpointId)
{
    return streamer::checkpoints::GetDynamicCheckpoint(checkpointId);
}

std::shared_ptr<streamer::ICheckpoint> OmpStreamerComponent::createDynamicCheckpoint(const Vector3& position, float size, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)
{
...
std::shared_ptr<streamer::ICheckpoint> OmpStreamerComponent::createDynamicCheckpointEx(const Vector3& position, float size, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicCheckpoint(int checkpointId)
{
    return streamer::checkpoints::DestroyDynamicCheckpoint(checkpointId);
}

// map icons
std::shared_ptr<streamer::IMapIcon> OmpStreamerComponent::getDynamicMapIcon(int mapIconId)
{
    return streamer::mapicons::GetDynamicMapIcon(mapIconId);
}

std::shared_ptr<streamer::IMapIcon> OmpStreamerComponent::createDynamicMapIcon(int modelId, const Vector3& position, int type, int color, int worldId, int interiorId, int playerId, float streamDistance, MapIconStyle style, int areaId, int priority)
{
...
std::shared_ptr<streamer::IMapIcon> OmpStreamerComponent::createDynamicMapIconEx(int modelId, const Vector3& position, int type, int color, int style, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicMapIcon(int mapIconId)
{
    return streamer::mapicons::DestroyDynamicMapIcon(mapIconId);
}

// objects
std::shared_ptr<streamer::IObject> OmpStreamerComponent::getDynamicObject(int objectId)
{
    return streamer::objects::GetDynamicObject(objectId);
}

std::shared_ptr<streamer::IObject> OmpStreamerComponent::createDynamicObject(int modelId, const Vector3& position, const Vector3& rotation, int worldId, int interiorId, int playerId, float streamDistance, float drawDistance, int areaId, int priority)
{
...
std::shared_ptr<streamer::IObject> OmpStreamerComponent::createDynamicObjectEx(int modelId, const Vector3& position, const Vector3& rotation, float streamDistance, float drawDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicObject(int objectId)
{
    return streamer::objects::DestroyDynamicObject(objectId);
}

std::shared_ptr<streamer::IObject> OmpStreamerComponent::getPlayerCameraTargetDynObject(int playerId)
{
    return streamer::objects::GetPlayerCameraTargetDynObject(playerId);
}

// pickups
std::shared_ptr<streamer::IPickup> OmpStreamerComponent::getDynamicPickup(int pickupId)
{
    return streamer::pickups::GetDynamicPickup(pickupId);
}

std::shared_ptr<streamer::IPickup> OmpStreamerComponent::createDynamicPickup(int modelId, int type, const Vector3& position, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)
{
...
std::shared_ptr<streamer::IPickup> OmpStreamerComponent::createDynamicPickupEx(int modelId, int type, const Vector3& position, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicPickup(int pickupId)
{
    return streamer::pickups::DestroyDynamicPickup(pickupId);
}

// race checkpoints
std::shared_ptr<streamer::IRaceCheckpoint> OmpStreamerComponent::getDynamicRaceCheckpoint(int raceCheckpointId)
{
    return streamer::racecheckpoints::GetDynamicRaceCheckpoint(raceCheckpointId);
}

std::shared_ptr<streamer::IRaceCheckpoint> OmpStreamerComponent::createDynamicRaceCheckpoint(int type, const Vector3& position, const Vector3& next, float size, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)
{
...
std::shared_ptr<streamer::IRaceCheckpoint> OmpStreamerComponent::createDynamicRaceCheckpointEx(int type, const Vector3& position, const Vector3& next, float size, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicRaceCheckpoint(int raceCheckpointId)
{
    return streamer::racecheckpoints::DestroyDynamicRaceCheckpoint(raceCheckpointId);
}

// textlabels
std::shared_ptr<streamer::ITextLabel> OmpStreamerComponent::getDynamicTextLabel(int textlabelId)
{
    return streamer::textlabels::GetDynamicTextLabel(textlabelId);
}

std::shared_ptr<streamer::ITextLabel> OmpStreamerComponent::createDynamicTextLabel(const std::string& text, int color, const Vector3& position, float drawDistance, int attachedPlayerId, int attachedVehicleId, bool testLOS, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)
{
...
std::shared_ptr<streamer::ITextLabel> OmpStreamerComponent::createDynamicTextLabelEx(const std::string& text, int color, const Vector3& position, float drawDistance, int attachedPlayerId, int attachedVehicleId, bool testLOS, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority)
{
...
bool OmpStreamerComponent::destroyDynamicTextLabel(int textlabelId)
{
    return streamer::textlabels::DestroyDynamicTextLabel(textlabelId);
}

// misc
std::optional<float> OmpStreamerComponent::getDistanceToItem(const Vector3& position, StreamerItemType itemType, int id, int dimensions)
{
    return streamer::miscellaneous::GetDistanceToItem(Eigen::Vector3f { position.x, position.y, position.z }, itemType, id, dimensions);
}

bool OmpStreamerComponent::toggleItem(int playerId, StreamerItemType itemType, int id, bool toggle)
{
