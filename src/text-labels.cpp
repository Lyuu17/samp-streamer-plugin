...
namespace streamer::textlabels
{
    ...
    Item::SharedTextLabel CreateDynamicTextLabel(std::optional<AMX*> amx, const std::string& text, int color, const Eigen::Vector3f& position, float drawDistance, int attachedPlayerId, int attachedVehicleId, bool testLOS, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)
    {
