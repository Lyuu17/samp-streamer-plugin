...
struct IOmpStreamerComponent : public IComponent
{
    ...
    virtual std::shared_ptr<streamer::IActor> createDynamicActorEx(int modelId, const Vector3& position, float rotation, bool invulnerable, float health, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority) = 0;
    ...
    virtual std::shared_ptr<streamer::ICheckpoint> createDynamicCheckpoint(const Vector3& position, float size, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)                                                                                                           = 0;
    virtual std::shared_ptr<streamer::ICheckpoint> createDynamicCheckpointEx(const Vector3& position, float size, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority) = 0;
    ...
    virtual std::shared_ptr<streamer::IMapIcon> createDynamicMapIcon(int modelId, const Vector3& position, int type, int color, int worldId, int interiorId, int playerId, float streamDistance, MapIconStyle style, int areaId, int priority)                                                                                                  = 0;
    virtual std::shared_ptr<streamer::IMapIcon> createDynamicMapIconEx(int modelId, const Vector3& position, int type, int color, int style, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority) = 0;
    ...
    virtual std::shared_ptr<streamer::IObject> createDynamicObject(int modelId, const Vector3& position, const Vector3& rotation, int worldId, int interiorId, int playerId, float streamDistance, float drawDistance, int areaId, int priority)                                                                                                           = 0;
    virtual std::shared_ptr<streamer::IObject> createDynamicObjectEx(int modelId, const Vector3& position, const Vector3& rotation, float streamDistance, float drawDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority) = 0;
    ...
    virtual std::shared_ptr<streamer::IRaceCheckpoint> createDynamicRaceCheckpoint(int type, const Vector3& position, const Vector3& next, float size, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)                                                                                                           = 0;
    virtual std::shared_ptr<streamer::IRaceCheckpoint> createDynamicRaceCheckpointEx(int type, const Vector3& position, const Vector3& next, float size, float streamDistance, const std::unordered_set<int>& worlds, const std::unordered_set<int>& interiors, const std::unordered_set<int>& players, const std::unordered_set<int>& areas, int priority) = 0;
    ...
    virtual std::shared_ptr<streamer::ITextLabel> createDynamicTextLabel(const std::string& text, int color, const Vector3& position, float drawDistance, int attachedPlayerId, int attachedVehicleId, bool testLOS, int worldId, int interiorId, int playerId, float streamDistance, int areaId, int priority)                                                                                                           = 0;
